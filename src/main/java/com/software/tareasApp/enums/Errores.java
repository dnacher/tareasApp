...
public enum Errores {
	...
	VERIFIQUE_ESTADO("Verifique el valor del estado", 28),
	...
	//Pago cuotas									391 - 400
	FALTAN_VALORES("Verifique que haya seleccionado todos los valores", 391),
	PASA_CUOTAS("Uno o mas registros sobrepasa la cantidad de cuotas a pagar", 391),
