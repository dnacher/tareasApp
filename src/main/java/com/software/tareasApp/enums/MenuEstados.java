...
public enum MenuEstados {
    ...
    EstadoSiniestro("EstadoSiniestro", "Estado del Siniestro","Estados", EstadoSiniestroController.class),
    EstadoPoliza("EstadoPoliza", "Estado de poliza","Estados", EstadoPolizaController.class),;
